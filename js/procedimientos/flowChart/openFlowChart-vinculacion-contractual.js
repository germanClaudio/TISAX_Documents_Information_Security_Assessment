...
function openFlowchartModal() {
    ...
    imageCaption.textContent = 'Diagrama de Flujo del proceso de Vinculación Legal Contractual';
...
function initFlowchartModal() {
    ...
    const existingImage = document.querySelector('img[src*="vinculacion-contractual-flowchart.png"]');
