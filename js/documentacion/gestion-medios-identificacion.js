...
function initializeQuickActions() {
    const reportIncidentBtn = document.getElementById('report-perdida-robo');
    ...
    if (reportIncidentBtn) {
        reportIncidentBtn.addEventListener('click', function() {
            ...
            const subject = 'Reporte de Robo/Perdida - Gestión de Medios Identificación';
            const body = `Hola equipo de seguridad,\n\nMe pongo en contacto para reportar el robo/perdida relacionado con medios de identificación:\n\n- Tipo de incidente:\n- Riesgo(s) identificado(s):\n- Fecha y hora:\n- Descripción:\n- Impacto estimado:\n\nSaludos cordiales.`;
