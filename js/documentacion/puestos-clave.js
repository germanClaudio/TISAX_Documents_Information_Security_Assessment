// puestos-clave.js - Funciones específicas para la página de Política de Puestos Clave
...
// Funciones adicionales específicas para la política de puestos clave
function exportTableToCSV(tableId, filename) {
    ...
    for (let i = 0; i < rows.length; i++) {
        ...
        for (let j = 0; j < cols.length; j++) {
            // Limpiar texto y manejar saltos de línea
